...
using DAL.Models;
using GroceryBuddy.Authorization;
using GroceryBuddy.Helpers;
using GroceryBuddy.OIDC;
...
namespace GroceryBuddy
{
    public class Program
    {
        ...
        private static void AddServices(WebApplicationBuilder builder)
        {
            ...
            var migrationsAssembly = typeof(Program).GetTypeInfo().Assembly.GetName().Name; //GroceryBuddy
        ...
        private static void ConfigureRequestPipeline(WebApplication app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - GroceryBuddy";
